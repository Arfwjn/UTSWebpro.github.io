            ...
            <div class="sidebar-wrapper">
                <nav class="mt-2"> <!--begin::Sidebar Menu-->
                    <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item"> <a href="data_loker.php" class="nav-link"> <i class="nav-icon bi bi-circle text-info"></i>
                                <p>Data Loker</p>
                            </a> </li>
                        <li class="nav-item"> <a href="kontak.php" class="nav-link"> <i class="nav-icon bi bi-circle text-info"></i>
                                <p>Kontak</p>
                            </a> </li>
